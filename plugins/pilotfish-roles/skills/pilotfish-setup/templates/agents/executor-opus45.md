---
name: executor-opus45
description: Version-pinned variant of executor, locked to Claude Opus 4.5 (claude-opus-4-5-20251101, no 1M context). Use ONLY when the user or orchestrator explicitly asks to run a task on Opus 4.5 (e.g. "用 opus-4-5 跑"); otherwise use the default executor. Same contract as executor - implementation requiring judgment, give it goal, constraints, and done-criteria.
